...
However, my team and I managed to turn things around. Adopting DORA metrics was one pivotal moment in this journey.

In this article, I’ll share how these metrics helped us pinpoint bottlenecks, redesign our workflows, and streamline processes, transforming a project once thought unsalvageable into a well-oiled machine.
...
* We’ve achieved things we once thought impossible. In just **five months**, we [resolved a massive security debt](https://ordinarytech.blog/caring-for-your-team-user-experience) accumulated over the previous 25 years. During that period, we deployed over **400 releases** without disturbing a single user. This level of throughput and stability was unimaginable when we started.
