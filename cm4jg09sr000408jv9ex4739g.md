...
* We’ve achieved things that seemed impossible before. In just **five months**, we [resolved a massive security debt](https://ordinarytech.blog/caring-for-your-team-user-experience) accumulated over the previous 25 years. During that period, we deployed over **400 releases** without disturbing a single user. This level of throughput and stability was unimaginable when we started.
